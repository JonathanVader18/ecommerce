...
Partial Class tiendas
    ...
    Private Sub tiendas_Load(sender As Object, e As EventArgs) Handles Me.Load
        Session("Page") = "tiendas.aspx"
    ...
    Public Sub fnCargaPagina()
        ssql = "select cvHtml, ISNULL(cvImagenBanner,'') as Banner from config.Paginas where cvNombre ='Tiendas'"
        Dim dtTitulo As New DataTable
        dtTitulo = objDatos.fnEjecutarConsulta(ssql)
        If dtTitulo.Rows.Count > 0 Then
