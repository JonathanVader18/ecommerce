<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TipoAtributos.aspx.vb" Inherits="TipoAtributos" %>
        ...
        <table style="width:100%;">
            <tr>
                <td class="auto-style1" colspan="2">
                    <asp:Label ID="Label1" runat="server" Text="Tipos de Atributos"></asp:Label>
                </td>
            ...
            <tr>
                <td>&nbsp;</td>
                <td colspan="3">
                    <telerik:RadGrid ID="rgvTipos" runat="server">
