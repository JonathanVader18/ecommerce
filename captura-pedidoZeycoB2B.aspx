<%@ Page Language="VB" AutoEventWireup="false" CodeFile="captura-pedidoZeycoB2B.aspx.vb" Inherits="captura_pedidoZeycoB2B"  MasterPageFile ="~/Main.master" %>
                ...
                <asp:Panel runat="server" ID="pnlSeparador" Visible="false">
                   ...
                   <%-- <div class="extra-o"><span>O</span></div>--%>
                    <div class="row alinear-botones">
                       ...
                       <div class="col-xs-12 col-sm-12"> <asp:Button ID="btnCotizar" CssClass="btn btn-general-4" runat="server" Text="cotizar" Visible="true" OnClientClick ="ShowProgress();" /></div> 
                      

                   
                        <div class="col-xs-12 col-sm-6"><asp:Button ID="btnPedido"  CssClass="btn btn-general-4" runat="server" Text="levantar pedido" Visible="false" OnClientClick ="ShowProgress();"  /></div>
                    </div>
        ...
        $(function () {
            $("[id$=txtSearch]").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/captura-pedidozeycoB2B.aspx/GetCustomers") %>',
