<%@ Page Language="VB" AutoEventWireup="false" CodeFile="captura-pedidoh.aspx.vb" Inherits="captura_pedidoh" MasterPageFile ="~/Main.master" %>
...
ErrorMessage="Ingrese un descuento válido" ControlToValidate="txtDesc1" />--%>
			...
			<div class="col-xs-4 cont-resumen">
				...
				<ul class="resumen">
					...
					<li><div><span> <asp:TextBox runat="server" ID="txtEnvio" style="text-align :right ;width :100%;" Visible="false"></asp:TextBox></span></div></li>
  ...
  <asp:Button ID="btnProcesar" CssClass ="btn btn-general-3" runat="server" Text="procesar la compra" Visible ="false"  OnClientClick ="ShowProgress();" />
     ...
     <ul class="resumen">
         ...
         <li> <asp:Button ID="btnSubir" runat="server" Text="subir" CssClass="btn btn-general-3" OnClientClick ="ShowProgress();"  /></li>
         <li><a href="/template/template.xlsx" target="_blank">Descargar plantilla para pedidos</a></li>
                ...
                <asp:Panel ID="pnlDireccionEntrega" runat="server" Visible="true">
                  ...
                  <ul class="resumen">
                      <li><asp:Label ID="lblAdicionalOtros" runat="server" Text="Comentarios"></asp:Label></li>
    ...
    $(function () {
        $("[id$=txtSearch]").autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("~/captura-pedidoh.aspx/GetCustomers") %>',
