<%@ Page Language="VB" AutoEventWireup="false" CodeFile="configBanners.aspx.vb" Inherits="configBanners" %>
                    ...
                    <ContentTemplate>
                                ...
                                <div class="row ">
                                    <div class="col-xs-12 col-sm-2 ">
                                        <asp:Button ID="Button1" runat="server" Text="subir imagen" CssClass="btn btn-general-2" OnClientClick ="ShowProgress();" />
                                    </div>
                                </div>
                                <div class="row ">
