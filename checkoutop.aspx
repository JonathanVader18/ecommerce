<%@ Page Language="VB" AutoEventWireup="false" CodeFile="checkoutop.aspx.vb" Inherits="checkoutop" %>
        ...
        $(document).ready(function() {
            ...
            var sucess_callbak = function(response) {
              ...
              $('#token_id').val(token_id);
                $('#payment-form').submit();
                document.getElementById("<%=txtToken.ClientID%>").value = token_id;
                document.getElementById("<%=txtDeviceId.ClientID%>").value = deviceSessionId;
...
.openpay div.logo {
    background-image: url("images/creditcards/openpay.png");
...
.openpay div.shield {
    background-image: url("images/creditcards/security.png");
    background-position: left bottom;
    background-repeat: no-repeat;
    font-size: 12px;
    font-weight: 400;
...
.card-expl div.debit {
    background-image: url("images/creditcards/cards2.png");
    margin-left: 20px;
    width: 540px;
}
.card-expl div.credit {
    background-image: url("images/creditcards/cards1.png");
    border-right: 1px solid #ccc;
    margin-left: 30px;
    width: 209px;
}
    ...
    <div class="bkng-tb-cntnt">
        <div class="pymnts">
            ...
            <asp:UpdatePanel ID="ResultsUpdatePanel" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
   <asp:Button ID="btnConfirmar" runat="server" Text="Confirmar" OnClientClick="ShowProgress();"   />
                            <asp:Label ID="label1" runat="server" Text="" ></asp:Label>
                 <asp:textbox ID="txtToken" runat="server" Text=""  ></asp:textbox>
                    <asp:textbox ID="txtDeviceId" runat="server" Text="" ></asp:textbox>
                     </ContentTemplate>
                <Triggers>
                   
                    <asp:PostBackTrigger ControlID="btnConfirmar"></asp:PostBackTrigger>
                </Triggers>
            </asp:UpdatePanel>
                 </form>
        </div>
