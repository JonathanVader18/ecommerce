<%@ Page Language="VB" AutoEventWireup="false" CodeFile="agregar-clienteZeyco.aspx.vb" Inherits="agregar_clienteZeyco" %>
		...
		<div class="main-container">
            ...
            <div class="col-xs-12 stl-1-p contenido">
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-4">
                                        <div class="form-group">
                                           ...
                                           <asp:DropDownList ID="ddlColonia" runat="server" Width="100%" AutoPostBack="True" CssClass="form-control"></asp:DropDownList>
                                        </div>
                                    </div>
                                       <div class="col-xs-12 col-sm-4">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Otra colonia</label>
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                      ...
                                      <div class="col-xs-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlEspecialidad" runat="server" Width="100%" AutoPostBack="True" CssClass="form-control"></asp:DropDownList>
                                            <asp:Panel ID="pnlOtro" runat="server" Visible ="false" > <label for="exampleInputEmail1">Indique cuál</label><asp:TextBox ID="txtOtro" runat="server" CssClass="form-control" Visible ="true" MaxLength="25"></asp:TextBox></asp:Panel>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                 ...
                                 <div class="row">
                                        <div class="col-xs-12 col-sm-12 txt-aling-left">
                                        <p>
                                            <asp:CheckBox ID="chkRevista" runat="server" Text ="Deseo recibir la revista Dental para Cual TOTALMENTE GRATIS"  AutoPostBack="True" /></p> 
                                   ...
                                   <div class="row">
                                        <div class="col-xs-12 col-sm-6">
                                          <asp:CheckBox ID="chkTerminos" runat="server" Text ="Al darte de alta, aceptas nuestro "  /><a class="link-aviso" href="https://zeyco.com/aviso-de-privacidad/" target="_blank">aviso de privacidad</a>
                                            </div>
                                       </div>
                ...
                <asp:AsyncPostBackTrigger ControlID="ddlPais" EventName="SelectedIndexChanged" ></asp:AsyncPostBackTrigger>
                   ...
                   <asp:AsyncPostBackTrigger ControlID="txtCP" EventName="TextChanged" ></asp:AsyncPostBackTrigger>
