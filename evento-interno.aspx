<%@ Page Language="VB" AutoEventWireup="false" CodeFile="evento-interno.aspx.vb" Inherits="evento_interno" MasterPageFile ="~/Main.master"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="col-xs-12">
		<div class="main-container">
			<h2 class="pag-cont-tit">evento</h2>
		</div>
	</div>
