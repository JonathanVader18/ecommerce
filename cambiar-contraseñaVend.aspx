<%@ Page Language="VB" AutoEventWireup="false" CodeFile="cambiar-contraseñaVend.aspx.vb" Inherits="cambiar_contraseñaVend"  %>
 						...
 						<div class="content-blok">
						    <div class="col-xs-12 col-sm-12">
                                ...
                                <asp:Button ID="btnGuardar" runat="server" Text="cambiar"  CssClass ="btn btn-general-2 btn-left"/>
                                  <asp:Button ID="btnRecuperar" runat="server" Text="iniciar sesión"  CssClass ="btn btn-general-7 btn-left" Visible ="false" />
                                <a type="submit" class="btn btn-general-1 btn-left" href="login.aspx">cancelar</a>
