<%@ Page Language="VB" AutoEventWireup="false" CodeFile="checkouthwk.aspx.vb" Inherits="checkouthwk" %>
...
<body>
     ...
     <div class="main-container" id="Principal">
		<div class="act-altcuenta">
			<div class="col-xs-12 col-sm-5">
                <img src="images/stop_negro.png" class="img-responsive cent-img" style="width:140px;height:120px;">
 ...
 <form action="" method="POST" id="card-form">
    ...
    <script type="text/javascript">
        $('#txtToken').hide();
        $('#btnConfirmar').hide();
        Conekta.setPublicKey("key_RfutdCGFdfDp3wMya4pQtRw");
