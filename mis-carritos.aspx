<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mis-carritos.aspx.vb" Inherits="mis_carritos" MasterPageFile ="~/Main.master" %>
		...
		<div class="main-container">
            ...
            <div class="col-xs-12 col-sm-10 stl-1-p contenido">
			 <div class="blk-genericos">
					<div class="tit-bloque"><h2>Mis Carritos Guardados</h2></div>
                   <asp:DropDownList ID="ddlCarritos" runat="server" class="select-general " AutoPostBack ="true" visible="false" ></asp:DropDownList>
