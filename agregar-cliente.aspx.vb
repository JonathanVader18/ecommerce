...
Partial Class agregar_cliente
    ...
    Private Sub agregar_cliente_Load(sender As Object, e As EventArgs) Handles Me.Load
        ''Cargamos los paises
        Dim fila As DataRow
        ...
        Try
            ...
            If oCompany.Connected Then
                ...
                Try
                    ...
                    oProspecto.UserFields.Fields.Item("U_DMS0006").Value = Session("UserTienda")
    ...
    Private Sub txtMailContacto_TextChanged(sender As Object, e As EventArgs) Handles txtMailContacto.TextChanged
        Try
            ''B
        Catch ex As Exception
