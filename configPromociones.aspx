<%@ Page Language="VB" AutoEventWireup="false" CodeFile="configPromociones.aspx.vb" Inherits="configPromociones" %>
...
<body class="gtk">
    <div class="main-container">
		<h1 class="tit-seccion">Administrar Promociones</h1>
	</div>
                                ...
                                <div class="row ">
                                    <div class="col-xs-12 col-sm-6 ">
                                     ...
                                     <div class="col-xs-12 col-sm-2 ">
                                        <div class="form-group">
                                         <asp:Button ID="btnActualizar" runat="server" Text="Actualizar" CssClass="btn btn-general-7" OnClientClick="ShowProgress();" />
                                        </div>
                                    </div>
 ...
 <asp:Button ID="btnAgregar" runat="server" Text="Agregar" CssClass="btn btn-general-7" OnClientClick="ShowProgress();" />
                          ...
                          <div class="legend">Artículos en categoría:</div>
                         <div class="tit-bloque">
                        </div>
                                <div class="row ">
                                    <div >
                                 ...
                                 <div class="row ">
                                       <div class="col-xs-12 col-sm-4 ">
                                        <asp:Button ID="btnNuevo" runat="server" Text="Nuevo" cssclass="btn btn-general-4" OnClientClick ="ShowProgress();" Visible ="false"/>
