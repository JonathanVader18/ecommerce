<%@ Page Language="VB" AutoEventWireup="false" CodeFile="agregar-clienteBM.aspx.vb" Inherits="agregar_clienteBM" %>
                                ...
                                <div class="row">
                                 ...
                                 <div class="row">
                                   ...
                                   <div class="row">
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Cantidad de clientes semanales</label>
                                            <asp:TextBox ID="txtCantClientes" runat="server" CssClass="form-control" TextMode = "Number"></asp:TextBox>
                                        </div>
                                       ...
                                       <div class="col-xs-12 col-sm-6">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">¿A cuántos artistas vende implementos?</label>
                                            <asp:TextBox ID="txtArtistasVende" runat="server" CssClass="form-control" TextMode = "Number"></asp:TextBox>
                                        </div>
                                  ...
                                  <div class="row">
                                      <div class="col-xs-12 col-sm-6">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Ámbito de las ventas</label>
                                             <asp:DropDownList ID="ddlAmbitoVentas" runat="server" Width="100%" AutoPostBack="True" CssClass="form-control"></asp:DropDownList>
                                        </div>
                                 ...
                                 <div class="row">
                                      <div class="col-xs-12 col-sm-6">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Sitio web</label>
                                 ...
                                 <div class="tit-bloque">
                                <div class="legend">Redes sociales</div>
                                     </div>
                                  <div class="row">
                                      <div class="col-xs-12 col-sm-4">
