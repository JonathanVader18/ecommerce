<%@ Page Language="VB" AutoEventWireup="false" CodeFile="configPlantillas.aspx.vb" Inherits="configPlantillas" %>
        ...
        <table style="width:100%;">
            <tr>
                <td class="auto-style1" colspan="2">
                    <asp:Label ID="Label1" runat="server" Text="Registrar Plantilla"></asp:Label>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnAgregarP0" runat="server" Text="Nueva Plantilla" Width="100%" />
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td class="auto-style3">
                    <asp:Button ID="btnAgregarP" runat="server" Text="Agregar Plantilla" Width="100%" />
                </td>
                <td class="auto-style5">
                    &nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                <td class="auto-style1" colspan="2">
                    <asp:Label ID="Label12" runat="server" Text="Agregar Campos a la Plantilla"></asp:Label>
                </td>
                <td class="auto-style4"></td>
                <td class="auto-style1"></td>
                <td class="auto-style1"></td>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnEliminar0" runat="server" Text="Eliminar Plantilla" Width="100%" />
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td class="auto-style3">
                    <asp:Label ID="Label11" runat="server" Text="Campo/Atributo"></asp:Label>
                </td>
                <td class="auto-style5">
            ...
            <tr>
                <td>&nbsp;</td>
                <td colspan="3">
                    <telerik:RadGrid ID="rgvPlantilla" runat="server">
