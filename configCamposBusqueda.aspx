<%@ Page Language="VB" AutoEventWireup="false" CodeFile="configCamposBusqueda.aspx.vb" Inherits="configCamposBusqueda" %>
...
<body>
    ...
    <div>
        ...
        <table style="width:100%;">
            <tr>
                <td colspan="2">
                    <asp:Label ID="Label12" runat="server" Text="Campos que utilizará el buscador para filtrar contenido"></asp:Label>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnAgregar" runat="server" Text="Agregar Criterio" />
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2">
                    <telerik:RadGrid ID="rgvCriterios" runat="server">
