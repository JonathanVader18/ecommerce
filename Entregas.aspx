<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Entregas.aspx.vb" Inherits="Entregas" MasterPageFile ="~/Main.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div class="col-xs-12">
		<div class="main-container">
			<div class="x_panel">
                    <asp:Label ID="lblTitulo" runat="server" Text="Entregas"></asp:Label>
                  </div>
