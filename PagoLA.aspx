<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PagoLA.aspx.vb" Inherits="PagoLA" MasterPageFile ="~/Main.master" EnableEventValidation ="false"%>
		...
		<div class="main-container">
			...
			<div class="col-xs-12">
				<ol class="breadcrumb">
				  ...
				  <li class="active"><a href="pagoLa.aspx">PAGO</a></li>
				...
				<div class="col-xs-12 col-sm-12">
                        ...
                        <div class="col-xs-6">
                            <div class="checkbox-2">
                               <label>
                                    <asp:CheckBox ID="chkFactura" runat="server" Text="¿Requiere factura?" AutoPostBack="True"  Visible ="true" Checked ="true" />
                               </label>
