...
Partial Class campanas
    ...
    Private Sub campanas_Load(sender As Object, e As EventArgs) Handles Me.Load
        Session("Page") = "tallas.aspx"
        ''Obtenemos el título de la página
        ssql = "select cvNombre from config.Menus where cvLink ='campanas.aspx' and cvTipoMenu ='Header'"
        Dim dtTitulo As New DataTable
        dtTitulo = objDatos.fnEjecutarConsulta(ssql)
        If dtTitulo.Rows.Count > 0 Then
