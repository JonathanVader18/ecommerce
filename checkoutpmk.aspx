<%@ Page Language="VB" AutoEventWireup="false" CodeFile="checkoutpmk.aspx.vb" Inherits="checkoutpmk" %>
...
<body>
     ...
     <div class="main-container" id="Principal">
		<div class="act-altcuenta">
			<div class="col-xs-12 col-sm-5">
                <img src="images/stop_negro.png" class="img-responsive cent-img" style="width:350px;height:120px;">
 ...
 <form action="" method="POST" id="card-form">
      ...
      <div class="form-group">
           <div class="row">
            ...
            <asp:Label ID="Label1" runat="server" Text="CVC"></asp:Label>
                ...
                <img src="images/logoConekta.png" style="width:100px;height:35px">
                <img src="images/secure.png" style="width:100px;height:45px">
                </div>
            </div>
         </div>
      <div class="container">
    ...
    <script type="text/javascript">
      ...
      //  Conekta.setPublicKey("key_NACBsWWYdBTwTJa5AXzqyqg");
         Conekta.setPublicKey("key_QDoyNgLu2z3jPScg1QnyMrA");
