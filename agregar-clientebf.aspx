<%@ Page Language="VB" AutoEventWireup="false" CodeFile="agregar-clientebf.aspx.vb" Inherits="agregar_clientebf" MasterPageFile ="~/Main.master"  %>
                    ...
                    <div class="blk-genericos extencion-2">
                        <div class="form-general">
                            ...
                            <fieldset>
                                ...
                                <p>Si ya estás dado de alta, haz clic <a href="loginb2b.aspx"> aquí </a> para iniciar sesión </p>
                                <div class="row">
                                 ...
                                 <div class="row">
                                      <div class="col-xs-12 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlTiposCliente" runat="server" Width="100%" AutoPostBack="True" CssClass="form-control"></asp:DropDownList>
                                        </div>
                                    </div>
                                 </div>
                                <asp:Button ID="btnEntrar" runat="server" Text="Registrarme" CssClass="btn btn-general-6" />
