<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mi-cuentala.aspx.vb" Inherits="mi_cuentala"   %>
			...
			<div class="col-xs-12">
	           ...
	           <!--  <div class="col-xs-12 text-center">
	            ...
	            <div class="marco-form">
                    ...
                    <div class="form-general" id="formulario">
                        <div class="form-group">
                            <label for="exampleInputEmail1">nombre completo</label>
                            <asp:TextBox ID="txtnombre" runat="server" CssClass="form-control"  onkeypress="return pulsar(event);"> </asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">RUT *</label>
                            <asp:TextBox ID="txtRFC" runat="server" CssClass="form-control" MaxLength="12" onkeypress="return justNumbers(event);" ></asp:TextBox>
                        </div>


                        <div class="form-group">
                            <label for="exampleInputEmail1">domicilio *</label>
                            <asp:TextBox ID="txtCalle" runat="server" CssClass="form-control"  onkeypress="return pulsar(event);"></asp:TextBox>
                        </div>
...
<asp:TextBox ID="txtMunicipio" runat="server" CssClass="form-control" Visible ="false" ></asp:TextBox>
    ...
    <div class="form-group">
                            ...
                            <asp:TextBox ID="txtTelefono" runat="server" CssClass="form-control"  onkeypress="return pulsar(event);"></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" CssClass="form-control"  onkeypress="return pulsar(event);"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">confirmar contraseña</label>
                            <asp:TextBox ID="txtConfirma" runat="server" TextMode="Password" CssClass="form-control"  onkeypress="return pulsar(event);"></asp:TextBox>
                        </div>
                        <div class="form-group">
