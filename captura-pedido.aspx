<%@ Page Language="VB" AutoEventWireup="false" CodeFile="captura-pedido.aspx.vb" Inherits="captura_pedido" MasterPageFile ="~/Main.master" %>
    ...
    $(function () {
        $("[id$=txtSearch]").autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("~/captura-pedido.aspx/GetCustomers") %>',
                        ...
                        <div class="row ">
                            ...
                            <div class="col-xs-12 col-sm-2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox runat="server" ID="txtcantidad" CssClass="form-control sprin"></asp:TextBox>
                                </div>
                            </div>
                              <div class="col-xs-12 col-sm-2">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox runat="server" ID="txtPrecioArt" CssClass="form-control" Visible ="True" ></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-2">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"></label>
                                    <asp:Button ID="btnCargar" CssClass="btn btn-general-2" runat="server" Text="Agregar" Visible="true" OnClientClick="ShowProgress();" />
                                </div>
                            </div>
                          
                        </div>
                         <asp:Label ID="lblExistencia" runat="server" Text="" CssClass ="exampleInputEmail1" Visible ="True"></asp:Label>
                        <div class="legend">Agregar producto no existente:</div>
                        <div class="row ">
                            <div class="col-xs-12 col-sm-4">
                                <div class="form-group">
                                    <asp:Label ID="lblDescAlt" runat="server" Text="Descripción Alternativa" Visible="True"></asp:Label>
                                    <asp:TextBox ID="txtDescripcionAlt" runat="server" CssClass="form-control" EnableTheming="True" Visible="True"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-2">
                                <div class="form-group">
                                    ...
                                    <label for="exampleInputEmail1">Cantidad</label>
                                    <asp:TextBox runat="server" ID="txtCantidadGen" CssClass="form-control sprin"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-2">
                                <div class="form-group">
                                    <asp:Label ID="lblDesc" runat="server" Text="%Desc" CssClass="exampleInputEmail1" Visible="True"></asp:Label>
                                    <asp:TextBox runat="server" ID="txtDesc" CssClass="form-control" Visible="True"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-2">
                                <div class="form-group">
                                    <asp:Label ID="lblPrecio" runat="server" Text="Precio" CssClass="exampleInputEmail1" Visible="True"></asp:Label>
                                    <asp:TextBox runat="server" ID="txtPrecio" CssClass="form-control" Visible="True"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-2 ">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"></label>
                                    <asp:Button ID="btnCargarGen" CssClass="btn btn-general-7" runat="server" Text="Agregar" Visible="true" OnClientClick="ShowProgress();" />
                                </div>
                            </div>

                            <asp:CheckBox ID="chkImpuestos" runat="server" Text="Aplica IVA" Checked="True" />
                        </div>
  ...
  <asp:Button ID="btnProcesar" CssClass ="btn btn-general-3" runat="server" Text="procesar la compra" Visible ="false"  OnClientClick ="ShowProgress();" />
                ...
                <asp:Panel runat="server" ID="pnlSeparador" Visible="false">
                   ...
                   <%-- <div class="extra-o"><span>O</span></div>--%>
                    <div class="row alinear-botones">
                       ...
                       <div class="col-xs-12 col-sm-6"> <asp:Button ID="btnCotizar" CssClass="btn btn-general-4" runat="server" Text="cotizar" Visible="false" OnClientClick ="ShowProgress();" /></div> 
                      

                   
                        <div class="col-xs-12 col-sm-6"><asp:Button ID="btnPedido" OnClick ="btnPedido_Click"  CssClass="btn btn-general-4" runat="server" Text="levantar pedido" Visible="false" OnClientClick ="ShowProgress();"  /></div>
                    </div>
                    <div class="extra-o"></div>
                </asp:Panel>
                
               <asp:Button ID="btnImprimir" CssClass ="btn btn-general-3" runat="server" Text="ver PDF" visible="false" />
                ...
                <asp:Panel ID="pnlImprimir" runat="server" visible="false">
                 ...
                 <asp:Panel ID="pnlDireccionEntrega" runat="server" Visible ="false" >
                  <ul class="resumen">
					...
					<li><span><asp:Label ID="Label1" runat="server" Text="Seleccione la dirección de entrega"></asp:Label></span></li>
					<li><div><asp:DropDownList ID="ddlDirecciones" runat="server"  Width ="100%"></asp:DropDownList></div></li>
              ...
              <%--  <asp:PostBackTrigger ControlID="btnPedido" />--%>
                       ...
                       <asp:PostBackTrigger ControlID="btnPedido" />
                          ...
                          <asp:PostBackTrigger ControlID="btnCargarGen" />
